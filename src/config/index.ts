...
const titleShort = 'R. Torcato'
const url = 'https://resume.matrixdigital.com'
...
const keywords = ['Full stack developer', 'Resume', 'developer', 'Programmer']
const author = 'rtorcato@me.com'
const email = 'rtorcato@me.com'
